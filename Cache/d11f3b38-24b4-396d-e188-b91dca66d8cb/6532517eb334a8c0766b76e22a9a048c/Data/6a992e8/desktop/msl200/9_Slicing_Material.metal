...
float param_2=(*sc_set0.UserUniforms).maxBorderSize;
Output_N10=param_2;
float Value_N17=0.0;
...
float l9_25=N24_MaxBorderSize;
float2 l9_26=l9_5;
float l9_27=fast::min(fast::min(l9_25,l9_26.x/2.0),l9_26.y/2.0);
float l9_28=l9_27;
float2 l9_29=N24_TextureSize;
float l9_30=l9_28;
float2 l9_31=float2((l9_29.x/l9_29.y)*l9_30,l9_30);
float2 l9_32=l9_31;
float l9_33=((N24_SliceLeft*l9_32.x)*2.0)/l9_5.x;
float l9_34=1.0-(((N24_SliceRight*l9_32.x)*2.0)/l9_5.x);
float l9_35=((N24_SliceBottom*l9_32.y)*2.0)/l9_5.y;
float l9_36=1.0-(((N24_SliceTop*l9_32.y)*2.0)/l9_5.y);
float l9_37=0.0+(((N24_UV.x-0.0)*(N24_SliceLeft-0.0))/((l9_33-0.0)+1e-06));
float l9_38=N24_SliceLeft+(((N24_UV.x-l9_33)*((1.0-N24_SliceRight)-N24_SliceLeft))/((l9_34-l9_33)+1e-06));
float l9_39=(1.0-N24_SliceRight)+(((N24_UV.x-l9_34)*(1.0-(1.0-N24_SliceRight)))/((1.0-l9_34)+1e-06));
float l9_40=0.0+(((N24_UV.y-0.0)*(N24_SliceBottom-0.0))/((l9_35-0.0)+1e-06));
float l9_41=N24_SliceBottom+(((N24_UV.y-l9_35)*((1.0-N24_SliceTop)-N24_SliceBottom))/((l9_36-l9_35)+1e-06));
float l9_42=(1.0-N24_SliceTop)+(((N24_UV.y-l9_36)*(1.0-(1.0-N24_SliceTop)))/((1.0-l9_36)+1e-06));
float l9_43;
if (N24_UV.x<l9_33)
{
l9_43=l9_37;
...
{
l9_43=(N24_UV.x<l9_34) ? l9_38 : l9_39;
}
float l9_44=l9_43;
float l9_45;
if (N24_UV.y<l9_35)
...
{
l9_45=(N24_UV.y<l9_36) ? l9_41 : l9_42;
}
float l9_46=l9_45;
N24_Result=float2(l9_44,l9_46);
param_14=N24_Result;
Result_N24=param_14;
...
float4 l9_125=fast::max(param_27,float4(0.0));
float4 param_28=l9_125;
if (sc_ShaderCacheConstant_tmp!=0)
{

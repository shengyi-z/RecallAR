...
// Config
var backendUrl = "https://your-backend-url.ngrok.io/identify"; // Replace with your ngrok/deployed URL
var useMock = true; // Set to false to use real backend
...
// Export the function
script.api.identify = identify;
script.api.setUseMock = function(val) { useMock = val; };
